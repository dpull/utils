...
unsigned char* filemapping_getdata(struct filemapping* filemapping) { return filemapping->data; }

size_t filemapping_getlength(struct filemapping* filemapping) { return filemapping->length; }

int filemapping_truncate(const char* file, size_t length) {
	BOOL ret = false;
...
int filemapping_truncate(const char* file, size_t length) { return truncate(file, length); }
#endif
